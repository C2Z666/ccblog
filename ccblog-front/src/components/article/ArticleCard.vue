      ...
      <div class="user-article-item-content cdc-article-panel__main">
        ...
        <div class="user-article-item-footer cdc-article-panel__infos">
          ...
          <div class="cdc-article-panel__date">
            {{format(article.createTime, "yyyy年MM月dd日 HH:mm")}}
           ...
           <template v-if="true">
            ...
            <div class="article-show-wrap">
              <!--  阅读计数  -->
                ...
                />
                <span class="cdc-icon__number">{{article.count.readCnt}}</span>
            </div>
            <div class="article-show-wrap">
              <!--  评论计数  -->
                <img
                ...
                />
                <span class="cdc-icon__number">{{article.count.commentCnt}}</span>
            </div>
            <div class="article-show-wrap">
              <!--  点赞计数  -->
              <!--  fixme 后续优化为可以直接在列表页进行点赞/取消  -->
                ...
                />
                <span class="cdc-icon__number">{{article.count.likeCnt}}</span>
            </div>
          </div>
           </template>
