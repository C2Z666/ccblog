...
//import com.ccblog.service.statistics.StatisticsSettingService; // todo:【未完成】先把统计相关注释
import com.ccblog.service.user.LoginService;
import com.ccblog.utils.CrossUtil;
import com.ccblog.utils.EnvUtil;
...
public class ReqRecordFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        StopWatch stopWatch = new StopWatch("请求耗时"); // 秒表
        try {
...
//            request.getSession().setAttribute("latestVisit", System.currentTimeMillis());
            ...
            // 初始化登录信息
            globalInitService.initLoginUser(reqInfo);  // 初始化reqInfo里面的登录用户信息,原来一直不行就是因为这里面的关键部分注释了
            stopWatch.stop();
